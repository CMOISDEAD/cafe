      ...
      <div className="relative flex justify-center items-center backdrop-blur-sm h-full overflow-hidden">
        <div className="font-bold font-serif text-center">
          ...
          <div className="md:text-3xl">
            <h3>Un proyecto de la Universidad del Quindío</h3>
        ...
        />
        <a
          href="https://www.uniQuindío.edu.co/programas/publicaciones/298/comunicacion-social-periodismo/"
          target="_blank"
        >
          <motion.img
            initial={{ opacity: 0, scale: 0.5 }}
